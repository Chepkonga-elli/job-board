    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="{{ route('posts.create') }}" class="nav-link px-2 text-white">New Post</a></li>
            ...
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search" action="{{ route('search') }}">
                <input name="q" class="form-control form-control-dark" type="search" placeholder="Search"
                    aria-label="Search">
            </form>
